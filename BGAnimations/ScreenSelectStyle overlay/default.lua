...
---- P1 TEXT NOHERE ------
    ...
    LoadActor("_selectarrow") .. {
        InitCommand=cmd(draworder,200;horizalign,center;x,SCREEN_CENTER_X-170;y,SCREEN_CENTER_Y+127;zoomx,0.5;zoomy,0.5;diffusealpha,0);
...
t[#t+1] = Def.ActorFrame {
	LoadActor("StartJoinSSS") .. {
	    Condition=not GAMESTATE:IsHumanPlayer(PLAYER_2);
		InitCommand=cmd(diffusealpha,0;x,SCREEN_CENTER_X+262;y,SCREEN_CENTER_Y+107);
